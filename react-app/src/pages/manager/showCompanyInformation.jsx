...
const showCompanyInformationUrl =
  "http://localhost:9091/api/v1/company/show-company-information?companyId=";

function showCompanyInformationMetod(selectedCompanyId) {
    console.log(selectedCompanyId)
    console.log(`${showCompanyInformationUrl}${selectedCompanyId}`)
  return fetch(`${showCompanyInformationUrl}${selectedCompanyId}`).then((resp)=>{
    return resp.json();
  }).then((data)=>{
    return data
  }).catch((err)=>{
